...
func _init():
	...
	bones = [
		...
		StandardBone.new(get_bone_i("センター"), get_bone_i("全ての親"), "Hips", null),
		StandardBone.new(get_bone_i("グルーブ"), get_bone_i("センター"), null, null),
		StandardBone.new(get_bone_i("腰"), get_bone_i("グルーブ"), null, null),
		StandardBone.new(get_bone_i("下半身"), get_bone_i("腰"), "Spine", null),
		StandardBone.new(get_bone_i("上半身"), get_bone_i("腰"), "Chest", null),
		StandardBone.new(get_bone_i("上半身2"), get_bone_i("上半身"), "UpperChest", null),
		StandardBone.new(get_bone_i("首"), get_bone_i("上半身2"), "Neck", null),
		StandardBone.new(get_bone_i("頭"), get_bone_i("首"), "Head", null),
		StandardBone.new(get_bone_i("両目"), get_bone_i("頭"), null, null),
		StandardBone.new(get_bone_i("左目"), get_bone_i("頭"), "LeftEye", null),
		StandardBone.new(get_bone_i("右目"), get_bone_i("頭"), "RightEye", null),

		StandardBone.new(get_bone_i("左肩P"), get_bone_i("上半身2"), "LeftShoulder", null),
		StandardBone.new(get_bone_i("左肩"), get_bone_i("左肩P"), null, null),
		StandardBone.new(get_bone_i("左肩C"), get_bone_i("左肩"), null, null),
		StandardBone.new(get_bone_i("左腕"), get_bone_i("左肩C"), "LeftUpperArm", null),
		StandardBone.new(get_bone_i("左腕捩"), get_bone_i("左腕"), null, null),
		StandardBone.new(get_bone_i("左ひじ"), get_bone_i("左腕捩"), "LeftLowerArm", null),
		StandardBone.new(get_bone_i("左手捩"), get_bone_i("左ひじ"), null, null),
		StandardBone.new(get_bone_i("左手首"), get_bone_i("左手捩"), "LeftHand", null),

		StandardBone.new(get_bone_i("右肩P"), get_bone_i("上半身2"), "RightShoulder", null),
		StandardBone.new(get_bone_i("右肩"), get_bone_i("右肩P"), null, null),
		StandardBone.new(get_bone_i("右肩C"), get_bone_i("右肩"), null, null),
		StandardBone.new(get_bone_i("右腕"), get_bone_i("右肩C"), "RightUpperArm", null),
		StandardBone.new(get_bone_i("右腕捩"), get_bone_i("右腕"), null, null),
		StandardBone.new(get_bone_i("右ひじ"), get_bone_i("右腕捩"), "RightLowerArm", null),
		StandardBone.new(get_bone_i("右手捩"), get_bone_i("右ひじ"), null, null),
		StandardBone.new(get_bone_i("右手首"), get_bone_i("右手捩"), "RightHand", null),
		...
		StandardBone.new(get_bone_i("左つま先ＩＫ"), get_bone_i("左足ＩＫ"), "LeftToe", null),
		StandardBone.new(get_bone_i("左足"), get_bone_i("下半身"), "LeftUpperLeg", null),
		StandardBone.new(get_bone_i("左足D"), get_bone_i("下半身"), null, null),
		StandardBone.new(get_bone_i("左ひざ"), get_bone_i("左足"), "LeftLowerLeg", null),
		StandardBone.new(get_bone_i("左ひざD"), get_bone_i("左足D"), null, null),
		StandardBone.new(get_bone_i("左足首"), get_bone_i("左ひざ"), "LeftFoot", null),
		StandardBone.new(get_bone_i("左足首D"), get_bone_i("左ひざD"), null, null),
		StandardBone.new(get_bone_i("左つま先"), get_bone_i("左足首"), "LeftToes", null),
		StandardBone.new(get_bone_i("左足先EX"), get_bone_i("左足首D"), null, null),
		...
		StandardBone.new(get_bone_i("右つま先ＩＫ"), get_bone_i("右足ＩＫ"), "RightToe", null),
		StandardBone.new(get_bone_i("右足"), get_bone_i("下半身"), "RightUpperLeg", null),
		StandardBone.new(get_bone_i("右足D"), get_bone_i("下半身"), null, null),
		StandardBone.new(get_bone_i("右ひざ"), get_bone_i("右足"), "RightLowerLeg", null),
		StandardBone.new(get_bone_i("右ひざD"), get_bone_i("右足D"), null, null),
		StandardBone.new(get_bone_i("右足首"), get_bone_i("右ひざ"), "RightFoot", null),
		StandardBone.new(get_bone_i("右足首D"), get_bone_i("右ひざD"), null, null),
		StandardBone.new(get_bone_i("右つま先"), get_bone_i("右足首"), "RightToes", null),
		StandardBone.new(get_bone_i("右足先EX"), get_bone_i("右足首D"), null, null)
	]
